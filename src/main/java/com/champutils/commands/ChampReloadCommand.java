...
import com.champutils.rewardtrack.RewardTrackConfig;
...
public class ChampReloadCommand {
    ...
    private static int reload(CommandSourceStack source) {
        ...
        try {
            ...
            reloadConfig(reloaded, "profession_fragments.json", ProfessionFragmentConfig::load);
            ...
            reloadConfig(reloaded, "profession_weapon_fragments.json", ProfessionWeaponFragmentConfig::load);
            reloadConfig(reloaded, "professions.json", ProfessionConfig::load);
            reloadConfig(reloaded, "quest_config.json", QuestConfig::load);
            reloadConfig(reloaded, "reward_track.json", RewardTrackConfig::load);
