...
public final class IslanderSpawningConfig {
    ...
    private static Config defaults() {
        ...
        c.progressionTiers.add(tier("tier_1", "Fresh Islander", 0L, 2, 10, 0, 1.00F));
        c.progressionTiers.add(tier("tier_2", "Settled Islander", 2L * 3600L, 8, 18, 0, 1.00F));
        c.progressionTiers.add(tier("tier_3", "Growing Islander", 6L * 3600L, 15, 30, 1, 1.00F));
        c.progressionTiers.add(tier("tier_4", "Veteran Islander", 15L * 3600L, 25, 45, 2, 1.00F));
        c.progressionTiers.add(tier("tier_5", "Master Islander", 30L * 3600L, 40, 60, 3, 1.00F));
